...
In the meantime, live wallpapers work exactly as you'd expect on your phone's own screen, and if you plug into a real desktop, the same library is waiting for you on Windows and macOS.
